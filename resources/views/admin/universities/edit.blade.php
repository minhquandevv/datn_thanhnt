...
@section('title', 'Chỉnh sửa trường đại học')

@section('content')
<div class="content-container">
    <div class="page-header mb-4">
        <h4 class="page-title">
            <i class="bi bi-pencil-square text-primary me-2"></i>Chỉnh sửa trường đại học
        </h4>
    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('representative_name') is-invalid @enderror" 
                            name="representative_name" value="{{ old('representative_name', $university->representative_name) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('representative_position') is-invalid @enderror" 
                            name="representative_position" value="{{ old('representative_position', $university->representative_position) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                            name="phone" value="{{ old('phone', $university->phone) }}" required>
                        @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>

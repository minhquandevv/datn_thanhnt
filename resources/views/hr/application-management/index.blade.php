            ...
            <ul class="nav nav-tabs nav-fill border-bottom" id="applicationTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $status === 'pending' ? 'active' : '' }}" 
                       href="{{ route('hr.application-management.index', ['status' => 'pending']) }}" 
                       role="tab">
                        Chờ tiếp nhận
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $status === 'processing' ? 'active' : '' }}" 
                       href="{{ route('hr.application-management.index', ['status' => 'processing']) }}" 
                       role="tab">
                        Chờ xử lý
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $status === 'approved' ? 'active' : '' }}" 
                       href="{{ route('hr.application-management.index', ['status' => 'approved']) }}" 
                       role="tab">
                        Đã duyệt
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ $status === 'rejected' ? 'active' : '' }}" 
                       href="{{ route('hr.application-management.index', ['status' => 'rejected']) }}" 
                       role="tab">
                        Đã từ chối
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($application->cv_file)
                                            <a href="{{ route('hr.application-management.download-cv', $application->id) }}" 
...
<form id="bulkActionForm" action="{{ route('hr.application-management.update-status') }}" method="POST" class="d-none">
    @csrf
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.view-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                /*
                fetch(`/hr/application-management/${id}/details`)

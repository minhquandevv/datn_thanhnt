    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="card-title">
                    <i class="bi bi-pencil"></i> Chỉnh sửa thông tin trường
                </h4>
            ...
            <form action="{{ route('admin.schools.update', $school) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="short_name" name="short_name" value="{{ old('short_name', $school->short_name) }}" required>
                </div>
